...
analysed_files.binaries = common.qt_wanted_binaries_filter(analysed_files.binaries)
analysed_files.datas = common.qt_wanted_datas_filter(analysed_files.datas)
analysed_files.pure.append(common.generate_builtin_exinfo(common.build_edition))
